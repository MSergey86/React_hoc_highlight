...
function highlight (props) {
    if (props.views < 100) return New;
    if (props.views >= 1000) return Popular;
    return null;
  }
  
function WithHighlight (highlight, Component) {
    return class extends React.Component {
        render() {
            const HighlightedComponent = highlight(this.props);
